...
//  eventsProject
//
//  Created by Pietro Putelli on 11/07/18.
...
class EventMapVC: UIViewController, MKMapViewDelegate {
    ...
    @IBAction func indexChanged(_ sender: UISegmentedControl) {
        if segmentedControl.selectedSegmentIndex == 0 {mapView.mapType = .standard
        } else {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        getDirectionOnMapButtonOutlet.setTitle(User.language.get_direction_map, for: .normal)
    }
}
