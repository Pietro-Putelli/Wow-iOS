...
//  eventsProject
//
//  Created by Pietro Putelli on 22/07/18.
//  Copyright © 2018 Pietro Putelli. All rights reserved.
//

import UIKit

@IBDesignable class CustomSegmenteControl: UIControl {
    
    private var labels = [UILabel]()
    var thumbView = UIView()
    
    var items: [String] = ["Item 1", "Item 2", "Item 3"] {didSet {setupLabels()}}
    
    var selectedIndex : Int = 0 {didSet {displayNewSelectedIndex()}}
    
    @IBInspectable var selectedLabelColor : UIColor = UIColor.black {didSet {setSelectedColors()}}
    
    @IBInspectable var unselectedLabelColor : UIColor = UIColor.white {didSet {setSelectedColors()}}
    
    @IBInspectable var thumbColor : UIColor = UIColor.white {didSet {setSelectedColors()}}
    
    @IBInspectable var borderColor : UIColor = UIColor.white {didSet {layer.borderColor = borderColor.cgColor}}
    
    @IBInspectable var font : UIFont! = UIFont.systemFont(ofSize: 12) {didSet {setFont()}}
    ...
    func displayNewSelectedIndex() {
        ...
        UIView.animate(withDuration: 0.5, delay: 0.0, usingSpringWithDamping: 1.0, initialSpringVelocity: 0.0, options: .allowAnimatedContent, animations: {
    ...
    func setSelectedColors() {
        ...
        for item in labels {item.textColor = unselectedLabelColor}
    ...
    func setFont() {for item in labels {item.font = font}}
}
